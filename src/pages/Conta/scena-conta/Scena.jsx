  ...
  return (
    <>
      ...
      <div className="container-3d">
        ...
        <Canvas
          camera={{
            position: [0, 300, 400], // Posición inicial de la cámara para que el modelo se vea completo
...
export default Scena; // Exporta el componente RecyCling para ser usado en otras partes de la aplicación