    ...
    return(
        ...
        <Header />
            <div className="container-consecuencia">
                ...
                <div className="container-2 "> 
                <p3>
                    <strong style={{color:"blue"}}> 5. Cambio climaticos: </strong>La contaminación de los océanos afecta profundamente su capacidad de absorber dióxido de carbono (CO₂), lo que contribuye al calentamiento global y la alteración de los patrones climáticos en todo el planeta           </p3>
                </div>
