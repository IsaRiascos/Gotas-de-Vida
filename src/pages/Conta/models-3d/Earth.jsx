...
import { useRef, useState, clickedObject , useEffect} from "react";
...
const earth = (props) => {
  const tierraRef = useRef()
  
  // Desestructuración del objeto retornado por useGLTF, que contiene los nodos y materiales del modelo GLTF
  const { nodes, materials,animations } = useGLTF("models3d/earth_cartoon.glb");
  const { actions } = useAnimations(animations, tierraRef)
  ...
  return (
    ...
    <group ref={tierraRef} {...props} dispose={null}>
...
useGLTF.preload("models3d/earth_cartoon");
