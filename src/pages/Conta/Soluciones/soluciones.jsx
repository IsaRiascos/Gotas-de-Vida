    ...
    <>
        ...
        <div className="container-solucione2">
            ...
            <p3>
                ...
                Por ejemplo, con el uso de este tipo de energías, la contaminación
                que se genera es mucho menor, siendo el uso de paneles solares una
                gran alternativa a tener en cuenta.
            </p3>
            <p3>
                <strong style={{ color: "blue" }}>
                {" "}
                ...
                Estos son menos contaminantes que otras alternativas, ya que
                vuelven de forma orgánica al entorno.
            </p3>
            <p3>
                <strong style={{ color: "blue" }}> 3. Reciclar envases: </strong>
                Especialmente si son de algún material como aluminio, vidrio o
                plástico, esto debido a que en su fabricación se utilizan
                diferentes diversos recursos.
            </p3>
            <p3>
                <strong style={{ color: "blue" }}>
                {" "}
                ...
                Acciones como cerrar el grifo, ducharse rápido y dar mantenimiento
                a las tuberías del hogar, pueden hacer la diferencia y evitar que
                haya agua contaminada innecesariamente.
            </p3>
            <p3>
                <strong style={{ color: "blue" }}>
                {" "}
                ...
                consumo del agua y para no verter en ella productos que la
                contaminen.
            </p3>
            </div>
        </div>
